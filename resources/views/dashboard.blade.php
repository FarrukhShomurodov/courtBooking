                    ...
                    <ul class="p-0 m-0">
                        <li class="mb-3 d-flex justify-content-between">
                            <div class="d-flex align-items-center lh-1 me-3">
                                <span class="badge badge-dot bg-success me-2"></span> Dashboard user
                            </div>
                        ...
                        <li class="mb-3 d-flex justify-content-between">
                            <div class="d-flex align-items-center lh-1 me-3">
                                <span class="badge badge-dot bg-danger me-2"></span> Bot user
                            </div>
                            <div class="d-flex gap-3">
        ...
        <div class="col-lg-4 col-12 mb-xl-0">
            <div class="card h-50">
                <div class="card-body text-center">
                    <span class="d-block text-nowrap">Stadiums</span>
            ...
            <div class="card h-50 mt-1">
                <div class="card-body text-center">
                    <span class="d-block text-nowrap">Courts</span>
