...
return [
    ...
    'attributes' => [
        ...
        'is_active' => 'Faol',
        'stadium_id' => 'Stadion',
        'sport_type_id' => 'Sport turi',
        'schedule' => 'Reja',
        'schedule.*.cost' => 'Narx',
        'schedule.*.start_time' => 'Boshlanish vaqti',
        'schedule.*.end_time' => 'Tugash vaqti',
        'address' => 'Manzil',
        'map_link' => 'Xarita havolasi',
        'sport_types' => 'Sport turlari',
        'sport_types.*' => 'Sport turi',
        'owner_id' => 'Stadion administratori',
        'manager_id' => 'Stadion administratori',
        'coach_id' => 'Murabbiy',
        'bot_user_id' => 'Bot foydalanuvchisi',
        'slots.*.court_id' => 'Maydon',
        'slots.*.start' => 'Boshlanish vaqti',
        'slots.*.end' => 'Tugash vaqti',
        'slots.*.date' => 'Sana',
        'slots.*.price' => 'Narx',
        'slots' => 'Slotlar',
    ],
